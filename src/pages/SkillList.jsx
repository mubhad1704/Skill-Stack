    ...
    <div className='min-h-screen flex flex-col bg-cover bg-center' style={{backgroundImage:"url('/bg2.jpg')"}}>
      ...
      <div className='flex-1 flex flex-col justify-center items-center'>
          ...
          <div className='grid  md:grid-cols-2 lg:grid-cols-3 gap-6 p-3'>
            <div className='border-2 p-5 rounded-xl border-[#00acb5] shadow-md shadow-[#00acb5a6] max-w-xs md:w-sm bg-white/40'>
              ...
              <div className='space-y-2 mt-3'>
                <p><strong>Type</strong> <span>➙</span> resource_type</p>
              <p><strong>Platform</strong> <span>➙</span>  platform</p>
              <p><strong>Status</strong> <span>➙</span> status</p>
              <p><strong>Hours</strong> <span>➙</span> hours</p>
              <p><strong>Difficulty</strong> <span>➙</span> difficulty</p>
              <p><strong>Notes</strong> <span>➙</span> notes</p>
              </div>
